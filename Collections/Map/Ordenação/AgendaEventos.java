...
public class AgendaEventos {
    ...
    public void obterProximoEvento() {
        ...
        for (Map.Entry<LocalDate, Evento> entry : eventosMap.entrySet()) {
            LocalDate dataEvento = entry.getKey();
            if ((proximaData == null || dataEvento.isBefore(proximaData)) && (dataEvento.isEqual(dataAtual) || dataEvento.isAfter(dataAtual))) {
    ...
    public static void main(String[] args) {
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2022, Month.JULY, 9), "Workshop de Programação", "Aula prática de desenvolvimento");
        ...
        agendaEventos.adicionarEvento(LocalDate.of(2024, Month.SEPTEMBER, 20), "Seminário de Inteligência Artificial", "Discussão sobre IA avançada");

        // Exibe a agenda completa de eventos
        System.out.println("Agenda completa de eventos:");
        agendaEventos.exibirAgenda();

        // Obtém e exibe o próximo evento na agenda
        System.out.println("\nPróximo evento na agenda:");
